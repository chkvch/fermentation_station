...
set output '/var/www/html/image/historyp_24h.png'
set xdata time
...
#plot "station.log" using 1:4 with lines title 'data'
...
plot "station_24h.log" using 1:4 with lines title 'data', \
 "station_24h.log" using 1:(avg_minute($4)) with lines title 'filter' lw 3 lt rgb "red", \
 "station_24h.log" using 1:(avg_hour($4)) with lines title 'filter' lw 2 lt rgb "cyan"
