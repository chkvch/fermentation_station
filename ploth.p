...
set output '/var/www/html/image/historyh.png'
set xdata time
...
plot "station.log" using 1:5 with lines title 'data',\
 "station.log" using 1:(avg_minute($5)) with lines title 'filter' lw 3 lt rgb "red", \
 "station.log" using 1:(avg_hour($5)) with lines title 'filter' lw 2 lt rgb "cyan"
