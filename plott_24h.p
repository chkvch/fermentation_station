...
set output '/var/www/html/image/historyt_24h.png'
set xdata time
...
plot "station_24h.log" using 1:3 with lines title 'data', \
 "station_24h.log" using 1:(avg_minute($3)) with lines title 'filter' lw 3 lt rgb "red", \
 "station_24h.log" using 1:(avg_hour($3)) with lines title 'filter' lw 2 lt rgb "cyan"
